...
from .errors import MailQueueFullError, MailUnicodeDecodeError
...
class Message(object):
    ...
    def __init__(self, subject='',
        ...
        sender = sender or current_app.mail.default_sender
    ...
    def _message(self):
        """Creates the email"""
        ascii_attachments = current_app.mail.ascii_attachments
...
class _MailMixin(object):
    ...
    def send(self, message):
        ...
        try:
            ...
            raise MailQueueFullError("Mail sending queue is full !")
...
class Mail(_MailMixin):
    ...
    def init_app(self, app):
        ...
        """
        state = self.init_mail(app.settings)
