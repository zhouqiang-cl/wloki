...
class MySQLConnection(object):
    ...
    def set_charset_collation(self, charset=None, collation=None):
        ...
        # Make Mysql-Connector-Python compatible with Cobar
        #self._execute_query("SET NAMES '{0}' COLLATE '{1}'".format(
            #charset_name, collation_name))

        self._execute_query("SET NAMES {0}".format(charset_name))
    ...
    def set_autocommit(self, value):
        ...
        self._execute_query("SET autocommit = {0}".format(switch))
